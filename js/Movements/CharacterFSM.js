...
export class CharacterFSM extends FiniteStateMachine {
    constructor(target) {
        ...
        this._targetDict = {
            ...
            Spine: {name: "Spine_02", mesh: null, initValue: null, setValue: {x:PI_14 ,y:0 ,z:0 }, index: 25}, 

            Neck: {name: "Neck_05" , mesh: null, initValue: null, setValue: {x:-PI_14 ,y:0 ,z:0 }, index: 26}, 

            Shoulder_sx: { name: "LeftShoulder_08", mesh: null, initValue: { x:0, y:-PI_3, z:0 }, setValue: null, index: 27},
            Upper_arm_sx: { name: "LeftArm_09", mesh: null, initValue: { x:PI_12, y:0, z:0 }, setValue: null, index: 28 },
            Lower_arm_sx: { name: "LeftForeArm_010", mesh: null, initValue:  null, setValue: null, index: 29},
            ...
            Shoulder_dx: { name: "RightShoulder_032", mesh: null, initValue: { x:0, y:PI_3, z:0 }, setValue: {x:-PI_12, y:0, z:0},  index: 36 },
            Upper_arm_dx: { name: "RightArm_033", mesh: null, initValue:  { x:PI_12, y:0, z:0 }, setValue: null, index: 37 },
            Lower_arm_dx: { name: "RightForeArm_034", mesh: null, initValue: null, setValue: null, index: 38   },
            Hand_dx: { name: "RightHand_035", mesh: null, initValue: null, setValue: null, setValue: null, index: 39 },

            Hips: {name: "Hips_01" , mesh: null, initValue: null, setValue: {x:0 ,y:PI_8 ,z:0 }, index: 40}, 
        };
        this._prepareDict();
